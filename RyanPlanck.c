...
[_primary_up] = {
  {LALT(KC_F4), KC_F1,               KC_F2,               KC_F3,             KC_F4,                KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_DELT  },
  {KC_TRNS,     LCTL(LSFT(KC_LEFT)), LCTL(LSFT(KC_DOWN)), LCTL(LSFT(KC_UP)), LCTL(LSFT(KC_RIGHT)), KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_F11,   KC_F12,   KC_TRNS  },
